...
// Sightline project. Kadia renders its exact virtual UI into a BGRA QImage,
// copies that image into an X8R8G8B8 offscreen surface, and lets D3D9 perform
// the final scaling/presentation to the native Qt HWND.
class D3D9Renderer
{
public:
    D3D9Renderer();
