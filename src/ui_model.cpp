...
const QVector<KadiaSectionInfo> &kadiaSections()
{
    static const QVector<KadiaSectionInfo> data = {
        ...
        { QStringLiteral("Games"), QStringLiteral("Browse and launch"), {
            ...
            { QStringLiteral("Jump A–Z"), QStringLiteral("A"), QStringLiteral("Jump to Letter"), QStringLiteral("Jump directly to titles beginning with a selected letter.") },
        ...
        { QStringLiteral("Arcade"), QStringLiteral("Arcade collections"), {
            ...
            { QStringLiteral("MAME"), QStringLiteral("M"), QStringLiteral("MAME"), QStringLiteral("MAME-based arcade library.") },
            { QStringLiteral("FBNeo"), QStringLiteral("F"), QStringLiteral("FinalBurn Neo"), QStringLiteral("FinalBurn Neo arcade library.") },
            ...
            { QStringLiteral("2 Players"), QStringLiteral("Ⅱ"), QStringLiteral("2 Players"), QStringLiteral("Automatic collection of two-player games.") },
            { QStringLiteral("4 Players"), QStringLiteral("Ⅳ"), QStringLiteral("4 Players"), QStringLiteral("Automatic collection of four-player games.") },
        } },
        { QStringLiteral("PC Games"), QStringLiteral("Windows and storefronts"), {
            ...
            { QStringLiteral("GOG"), QStringLiteral("G"), QStringLiteral("GOG"), QStringLiteral("Games detected from GOG.") },
            { QStringLiteral("EA"), QStringLiteral("E"), QStringLiteral("EA Games"), QStringLiteral("Games detected from the EA app.") },
            { QStringLiteral("Amazon"), QStringLiteral("A"), QStringLiteral("Amazon Games"), QStringLiteral("Games detected from Amazon Games.") },
        } },
        { QStringLiteral("Collections"), QStringLiteral("Automatic and custom collections"), {
            ...
            { QStringLiteral("2 Players"), QStringLiteral("Ⅱ"), QStringLiteral("2 Players"), QStringLiteral("Games identified as supporting two players.") },
            { QStringLiteral("4 Players"), QStringLiteral("Ⅳ"), QStringLiteral("4 Players"), QStringLiteral("Games identified as supporting four players.") },
        ...
        { QStringLiteral("Game Settings"), QStringLiteral("Global emulation configuration"), {
            ...
            { QStringLiteral("AI Translation"), QStringLiteral("A"), QStringLiteral("AI Game Translation"), QStringLiteral("Configure supported game-translation functionality.") },
        ...
        { QStringLiteral("Interface Settings"), QStringLiteral("Appearance and navigation"), {
            ...
            { QStringLiteral("Filenames"), QStringLiteral("A"), QStringLiteral("Filenames"), QStringLiteral("Use ROM filenames instead of metadata names when desired.") },
        ...
        { QStringLiteral("Controllers"), QStringLiteral("Controller configuration"), {
            ...
            { QStringLiteral("Player 1"), QStringLiteral("Ⅰ"), QStringLiteral("Player 1"), QStringLiteral("Assign a default controller to Player 1.") },
            { QStringLiteral("Player 2"), QStringLiteral("Ⅱ"), QStringLiteral("Player 2"), QStringLiteral("Assign a default controller to Player 2.") },
            { QStringLiteral("Player 3"), QStringLiteral("Ⅲ"), QStringLiteral("Player 3"), QStringLiteral("Assign a default controller to Player 3.") },
            { QStringLiteral("Player 4"), QStringLiteral("Ⅳ"), QStringLiteral("Player 4"), QStringLiteral("Assign a default controller to Player 4.") },
        ...
        { QStringLiteral("Scraper"), QStringLiteral("Metadata and media"), {
            ...
            { QStringLiteral("Game Info"), QStringLiteral("A"), QStringLiteral("Game Information"), QStringLiteral("Scrape title, year, players, description and related metadata.") },
        ...
        { QStringLiteral("System Settings"), QStringLiteral("Frontend and system"), {
            { QStringLiteral("Information"), QStringLiteral("i"), QStringLiteral("System Information"), QStringLiteral("Display system and frontend information.") },
            { QStringLiteral("Language"), QStringLiteral("A"), QStringLiteral("Language"), QStringLiteral("Choose the interface language.") },
